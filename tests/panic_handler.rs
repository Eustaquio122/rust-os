...
use core::fmt;
use core::fmt::Write;
use os::{serial_print, serial_println, QemuExitCode, exit_qemu};


const PANIC_MESSAGE: &str = "Panic handler test output";
...
fn check_message(info: &PanicInfo) {
    ...
    let mut compare_message = CompareMessage { expected: PANIC_MESSAGE };
